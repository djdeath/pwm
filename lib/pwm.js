...
var getChipPath = function(chipNum) {
    return pwmpath + '/pwmchip' + chipNum;
};
var getPinPath = function(chipNum, pinNum) {
    return getChipPath(chipNum) + '/pwm' + pinNum;
};
...
var PWM = function(chipNum, pinNum) {
 ...
 */
PWM.prototype.export = function(fn) {
    _export(this.chipNum, this.pinNum, function() {
        this.ready = true;
        if (typeof fn === "function") fn();
...
exports.export = function(chipNum, pinNum, fn) {
    var pwm = new PWM(chipNum, pinNum);
    pwm.export(fn);
    return pwm;
};
